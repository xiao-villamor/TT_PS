...
public class getAssistantActivitiesUseCase {

    public static Result<QueryResult<List<ActivityModel>,DocumentSnapshot>, Exception> getAssistantActivitiesUseCase(String uuid, Integer count) throws InterruptedException {
        ...
        Thread t = new Thread(() -> {
            try {
                res.data = repository.getAssistantActivitiesById(uuid, count);
