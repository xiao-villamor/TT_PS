...
public class getFirstActivitiesFiltered {
    ...
    public static Result<QueryResult<List<ActivityModel>,Boolean>, Exception> getActivitiesFiltered(List<String> tags, List<Float> Range, GeoLocation location) throws InterruptedException{
